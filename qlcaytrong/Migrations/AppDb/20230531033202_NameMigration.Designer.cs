...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("qlcaytrong.Models.AspNetUser", b =>
                {
            ...
            modelBuilder.Entity("qlcaytrong.Models.ChiTietDonHang", b =>
                {
            ...
            modelBuilder.Entity("qlcaytrong.Models.DanhGium", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("qlcaytrong.Models.DanhMuc", b =>
                {
            ...
            modelBuilder.Entity("qlcaytrong.Models.DichVu", b =>
                {
            ...
            modelBuilder.Entity("qlcaytrong.Models.DonHang", b =>
                {
                    b.Property<int>("Madon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("qlcaytrong.Models.KhachHang", b =>
                {
                    b.Property<int>("Makh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("qlcaytrong.Models.KhachHangRole", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int")
                        .HasColumnName("RoleID");
            ...
            modelBuilder.Entity("qlcaytrong.Models.SanPham", b =>
                {
                    b.Property<int>("Masp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("qlcaytrong.Models.ThuVienAnh", b =>
                {
                    b.Property<int>("Idthuvien")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("qlcaytrong.Models.ChiTietDonHang", b =>
                {
                    b.HasOne("qlcaytrong.Models.DonHang", "MadonNavigation")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("Madon")
                        .HasConstraintName("FK__ChiTietDo__madon__36B12243")
                        .IsRequired();

                    b.HasOne("qlcaytrong.Models.SanPham", "MaspNavigation")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("Masp")
            ...
            modelBuilder.Entity("qlcaytrong.Models.DanhGium", b =>
                {
                    b.HasOne("qlcaytrong.Models.KhachHang", "IdKhNavigation")
                        .WithMany("DanhGia")
                        .HasForeignKey("IdKh")
                        .HasConstraintName("FK__DanhGia__id_kh__3C69FB99");

                    b.HasOne("qlcaytrong.Models.SanPham", "IdSpNavigation")
                        .WithMany("DanhGia")
                        .HasForeignKey("IdSp")
            ...
            modelBuilder.Entity("qlcaytrong.Models.DichVu", b =>
                {
                    b.HasOne("qlcaytrong.Models.KhachHang", "MakhNavigation")
                        .WithMany("DichVus")
                        .HasForeignKey("Makh")
            ...
            modelBuilder.Entity("qlcaytrong.Models.KhachHang", b =>
                {
                    b.HasOne("qlcaytrong.Models.KhachHangRole", "Role")
                        .WithMany("KhachHangs")
            ...
            modelBuilder.Entity("qlcaytrong.Models.SanPham", b =>
                {
                    b.HasOne("qlcaytrong.Models.DanhMuc", "IdDanhmucNavigation")
                        .WithMany("SanPhams")
                        .HasForeignKey("IdDanhmuc")
                        .HasConstraintName("FK__SanPham__idDanhm__286302EC");

                    b.HasOne("qlcaytrong.Models.ThuVienAnh", "IdthuvienNavigation")
                        .WithMany("SanPhams")
