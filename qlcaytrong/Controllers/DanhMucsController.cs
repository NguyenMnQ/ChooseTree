...
namespace qlcaytrong.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDanhmuc,Tendanhmuc,ParentId")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDanhmuc,Tendanhmuc,ParentId")] DanhMuc danhMuc)
        {
